...
if __name__ == '__main__':
    ...
    assert args.no_track_stat, "When not adv training, no_track_stat should be set."

    # FIXME ad-hoc the split-mix specific configs. Should remove other options.
    # args.slim_mode = 'ensemble'  # 'ensemble: ensemble atom models; slimmable: train different ratios.')
    # args.slim_sch = 'group_max'  # 'group_max: each group will define a max ratio; '
    # args.shift_sch = 'shuffle'  # 'schedule the shift of atom model. none: bias at 0')
